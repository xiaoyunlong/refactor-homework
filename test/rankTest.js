...
rankTest('case18: voyageProfitFactor test history length < 10 and zone is east-indies and history.length > 8 and voyage.length = 14', t => {
  const voyage = {
    zone: 'east-indies',
    length: 14,
  };
...
rankTest('case19: voyageProfitFactor test history length < 10 and zone is west-indies  and history.length > 8 and voyage.length = 14', t => {
  const voyage = {
    zone: 'west-indies',
    length: 14,
  };
...
rankTest('case21:  test rating result is A', t => {
  const voyage = {
    zone: 'china',
    length: 13,
  };
